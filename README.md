Тестовый проект для имитации склада носков, позволяет выполнять запросы на сервер, получая при этом требуемое количество объектов по заданным параметрам.
